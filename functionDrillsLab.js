...
//CODE HERE
let compareNums = (num1, num2) => (num1>num2) ? num1: (num1===num2 ? num1 : num2)
...
//CODE HERE
const nameCheck = (name) => name === 'Steven' ? `What os up ${name}?` : (name === 'Bryan' ? `Hey ${name}` : `Cool nema, Nameparam`)
...
/*
  ...
  Create a variable called 'colorRating' and set it equal
   to faveColorFinder invoked (called), passing in an argument.
*/

//CODE HERE
const faveColorFinder = (color) => color === 'red' ? `${color} is a great color` : (color === `green` ? `${color}\
 is a solid favorite color` : (color === 'black' ? `so trendy` : 'you need to evaluate your favorit color choice'))
...
//CODE HERE
const printAllNames = (arr) => {for (i in arr) {console.log(namesArr[i])}}
...
//CODE HERE
const bestMovie = (title) => `${title} is the best move ever!`
...
//CODE HERE
function makeItLow(str) {
  str = str.toLowerCase()
  return str
}
console.log(makeItLow(sampleString))
